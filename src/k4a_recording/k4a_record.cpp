...
class K4AViewer{
    ...
    public:
        // Constructor
        K4AViewer() : viewer ("PCL Viewer")
        {
            frame_saved = 0; // init
            save_flag = false;
            viewer.setCameraPosition(0.0, 0.0, -2500.0, 1.0, -1.0, 1.0);
        }
        // Cloud Processor Function
        void cloud_process(const PointCloud<PointXYZRGBA>::ConstPtr &cloud)
        {
            // cout << "Callback" << endl;
            ...
            if(!viewer.wasStopped()){
                ...
                //     // if failing to update then add a new PointCloud
                ...
                color_cloud = input_cloud->makeShared();
                if (color_cloud)
                {
        ...
        void run()
        {
            ...
            boost::function<void (const PointCloud<PointXYZRGBA>::ConstPtr &)> f =
                boost::bind(& K4AViewer::cloud_process, this, _1);
