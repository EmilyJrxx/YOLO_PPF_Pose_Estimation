...
string OUT_DIR = "../clouds/scan_output/";
    ...
    public:
        ...
        void run ()
        {
            pcl::Grabber* grabber = new pcl::KinectAzureDKGrabber(
                0, K4A_DEPTH_MODE_NFOV_2X2BINNED, K4A_IMAGE_FORMAT_COLOR_BGRA32, K4A_COLOR_RESOLUTION_720P);
...
int main (int argc, char** argv)
{
  ...
  // xmin=0; ymin= -100;zmin= 0;
  // xmax=110; ymax= 140;zmax=600;
  xmin=-300; ymin= -200;zmin= 450;
  xmax=300; ymax= 120;zmax=800;
